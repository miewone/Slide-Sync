...
const metricLabels={
  firstPreviewMs:'첫 미리보기 내용 로드',renderReadyMs:'전체 슬라이드 캐시 준비',openReadyMs:'편집 활성화 (백그라운드 보관 제외)',
