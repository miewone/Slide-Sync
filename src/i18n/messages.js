...
export const messages = {
  'native.imageFailed': {ko:'이미지를 불러오지 못했습니다',en:'Image could not be loaded'},
  'native.resizeSavedPreview': {ko:'저장본 미리보기 크기 조절: 모서리 드래그 또는 방향키',en:'Resize saved preview: drag the corner or use arrow keys'},
  "native.previewFonts": {"ko": "미리보기 글꼴 대체", "en": "Preview font replacement"},
  "native.previewFontHelp": {"ko": "위 글꼴 이름의 미리보기와 크기 측정에만 적용합니다. Google 문서의 글꼴은 바뀌지 않으며 업로드한 파일은 전송되지 않습니다.", "en": "Applies only to preview and measurement for the family above. Google document fonts stay unchanged and uploaded font files are not sent."},
  "native.replacement": {"ko": "대체할 글꼴", "en": "Replacement font"},
  "native.uploadFont": {"ko": "글꼴 파일 불러오기", "en": "Load font file"},
  "native.originalFont": {"ko": "원래 미리보기 글꼴", "en": "Restore original preview font"},
  "native.fontLimit": {"ko": "글꼴 파일은 32MB 이하로 선택해 주세요.", "en": "Choose a font file of 32 MB or less."},
  "native.appearance": {"ko": "모양이 비슷한 요소 선택", "en": "Select similar objects"},
  "native.size": {"ko": "크기", "en": "Size"},
  "native.colors": {"ko": "색상", "en": "Colors"},
  "native.layout": {"ko": "위치·모양", "en": "Position and shape"},
  "native.selectSimilar": {"ko": "첫 선택 요소와 비슷한 요소 추가", "en": "Add objects similar to the first selection"},
  "native.apply": {"ko": "적용", "en": "Apply"},
  "native.fontFamily": {"ko": "글꼴 이름", "en": "Font family"},
  "native.noText": {"ko": "적용할 텍스트 상자가 없습니다. 선택 범위와 배경 필터를 확인해 주세요.", "en": "No eligible text boxes. Check the selection and background filter."},
  "native.fitHelp": {"ko": "텍스트 상자의 너비·높이를 브라우저에서 측정합니다. 그룹 내부와 표는 크기 맞춤에서 제외합니다. 글꼴·여백·테마에 따라 Google 저장본과 차이가 날 수 있으므로 저장 후 미리보기를 확인하세요.", "en": "Text box width and height are measured in this browser. Grouped shapes and tables are excluded from fitting. Fonts, margins and themes may differ from Google; check the saved preview."},
  "native.guides": {"ko": "안내선", "en": "Guides"},
  "native.guideHelp": {"ko": "이 편집 화면에서 사용하는 안내선입니다. Google Slides 안내선으로 저장되지 않으며 화면을 닫으면 사라집니다.", "en": "Guides apply to this editing session. They are not saved as Google Slides guides and are cleared when you close this workspace."},
  "native.showGuides": {"ko": "안내선 표시", "en": "Show guides"},
  "native.snap": {"ko": "드래그 시 안내선에 맞춤", "en": "Snap dragging to guides"},
  "native.axis": {"ko": "방향", "en": "Axis"},
  "native.position": {"ko": "위치 (cm)", "en": "Position (cm)"},
  "native.add": {"ko": "추가", "en": "Add"},
  "native.slideSearch": {"ko": "슬라이드 내용 검색", "en": "Search slide text"},
  "native.checkMatches": {"ko": "검색 결과 슬라이드 체크", "en": "Check matching slides"},
  "native.range": {"ko": "슬라이드 범위", "en": "Slide range"},
  "native.onlyChecked": {"ko": "체크한 슬라이드만 표시", "en": "Show checked slides only"},
  "native.onlySelected": {"ko": "선택 요소가 있는 슬라이드만 표시", "en": "Show slides with selected objects only"},
  ...
  'drive.gcloudCopy': {ko:'명령 복사',en:'Copy commands'},
  'drive.gcloudCopied': {ko:'명령을 복사했습니다.',en:'Commands copied.'},
  'drive.gcloudCopyFailed': {ko:'복사하지 못했습니다. 아래 명령을 직접 선택해 복사하세요.',en:'Could not copy. Select and copy the commands below.'},
  'drive.gcloudConsoleTitle': {ko:'콘솔에서 마무리할 항목',en:'Finish in Google Cloud Console'},
  'drive.gcloudConsent': {ko:'같은 프로젝트에서 OAuth 동의 화면을 설정하고, 테스트 중이면 본인 계정을 테스트 사용자로 등록합니다.',en:'Configure OAuth consent in the same project and add your account as a test user if the app is in testing.'},
  'drive.gcloudBranding': {ko:'OAuth 브랜딩',en:'OAuth branding'},
  'drive.gcloudClient': {ko:'OAuth 클라이언트를 웹 애플리케이션 유형으로 만듭니다.',en:'Create an OAuth client with the Web application type.'},
  'drive.gcloudFinish': {ko:'발급된 클라이언트 ID와 위 명령으로 조회한 API 키·프로젝트 번호를 입력하고 저장하세요. 클라이언트 Secret은 사용하지 않습니다.',en:'Enter the client ID and the API key and project number from the commands, then save. No client secret is used.'},
  'drive.gcloudReference': {ko:'gcloud API 키 명령 공식 문서',en:'Official gcloud API key command reference'},
  'drive.settingsTitle': {ko:'내 Google API 설정',en:'My Google API settings'},
  'drive.settingsHelp': {ko:'같은 Google Cloud 프로젝트에서 발급한 세 값을 입력하세요. 이 브라우저에만 저장합니다. 클라이언트 Secret은 입력하지 않습니다.',en:'Enter all three values from the same Google Cloud project. They are saved only in this browser. Do not enter a client secret.'},
  'drive.settingsClient': {ko:'OAuth 클라이언트 ID',en:'OAuth client ID'},
  'drive.settingsProject': {ko:'프로젝트 번호 (숫자)',en:'Project number (digits)'},
  'drive.settingsOrigin': {ko:'OAuth의 승인된 JavaScript 원본에 등록할 주소:',en:'Add this URL to your OAuth authorized JavaScript origins:'},
  'drive.settingsGuide': {ko:'Google API·인증 정보 설정 안내',en:'Google API and credential setup guide'},
  'drive.settingsSave': {ko:'이 브라우저에 저장',en:'Save in this browser'},
  'drive.settingsRemove': {ko:'저장한 설정 삭제',en:'Delete saved settings'},
  'drive.settingsClientInvalid': {ko:'올바른 웹 OAuth 클라이언트 ID를 입력하세요 (.apps.googleusercontent.com).',en:'Enter a valid web OAuth client ID ending in .apps.googleusercontent.com.'},
  'drive.settingsKeyInvalid': {ko:'AIza로 시작하는 Google API 키를 입력하세요.',en:'Enter a Google API key starting with AIza.'},
  'drive.settingsProjectInvalid': {ko:'OAuth 클라이언트와 같은 프로젝트의 숫자 프로젝트 번호를 입력하세요.',en:'Enter the numeric project number matching your OAuth client.'},
  'drive.settingsStorageError': {ko:'브라우저에 Google 설정을 저장하거나 읽지 못했습니다. 사이트 저장소 허용 여부를 확인해 주세요.',en:'Could not save or read Google settings in this browser. Check site storage permissions.'},
  'fileOpen.title': {ko:'파일을 열 위치 선택',en:'Choose where to open a file'},
  ...
  'download.destination': {ko:'수정본 저장 위치',en:'Save edited PPTX'},
  'download.destinationHelp': {ko:'내 컴퓨터에 다운로드하거나 Google Drive에 저장하세요.',en:'Download to your computer or save to Google Drive.'},
  'download.local': {ko:'내 컴퓨터에 다운로드',en:'Download to my computer'},
  ...
  "drive.privacy": {"ko": "선택한 PPTX·Google Slides를 Google에서 읽고, 저장 버튼을 누르면 선택한 위치에 저장합니다. 접근 토큰은 만료 전까지 이 브라우저에 보관하며, 연결 해제 시 삭제합니다.", "en": "Selected PPTX and Google Slides files are read from Google and saved to your chosen destination when you press Save. Access tokens are kept in this browser until they expire and are deleted when you disconnect."},
  ...
  "drive.nativeHelp": {"ko": "Google Slides 원본 객체를 편집합니다. 검색·영역 선택·드래그·정렬·텍스트 서식·크기 맞춤과 실행 취소를 지원합니다. 편집은 저장 버튼을 누를 때 Google에 반영됩니다.", "en": "Edit native Google Slides objects with search, box selection, dragging, alignment, text formatting, fitting and undo. Changes reach Google when you press Save."},
  ...
  "drive.layoutHelp": {"ko": "요소를 클릭해 선택하고 드래그해 이동합니다. 빈 곳에서 드래그하면 체크한 슬라이드 전체에서 같은 영역의 요소를 선택합니다. Shift는 선택 추가·축 고정, 방향키는 이동, Ctrl/Cmd+Z는 실행 취소입니다. 아래 배치는 편집용 근사 미리보기입니다.", "en": "Click objects to select and drag to move. Drag empty space to select the same area across checked slides. Shift adds to selection or locks the drag axis; arrows move; Ctrl/Cmd+Z undoes. This is an approximate editing preview."},
