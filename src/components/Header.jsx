...
export function Header() {
  ...
  return <header className={`topbar${busy ? ' busy' : ''}`}>
    ...
    <div className="header-actions">
      ...
      <GoogleDriveControls renderTrigger={({openDrive,openRecentDrive,openSettings,openDownload,disabled:driveDisabled})=><>
        ...
        <Button id="download" variant="primary" disabled={!hasDeck||busy||driveDisabled} onClick={openDownload}>{t('Header.6')}<span>↓</span></Button>
      </>}/>
    </div>
