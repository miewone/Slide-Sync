...
export function SelectionPanel() {
  return <InspectorSection id="editor-section-selection" title="선택 결과" initiallyOpen={false}>
      ...
      <p>브라우저 미리보기는 PowerPoint와 글꼴·효과가 다를 수 있습니다. 원본 파일에서 선택한 요소의 위치와 텍스트 상자 높이를 수정해 저장합니다. 클릭 판정은 요소의 회전된 사각 영역 기준입니다. 그룹은 한 단위로 이동하며 배경과 마스터 요소는 편집 대상에서 제외됩니다.</p>
      </details>
  </InspectorSection>;
}
